...
What DOES count as an illustration:
- Drawings of people performing martial arts poses or combat techniques
- Drawings of weapons, equipment, or tactical diagrams
- Maps, battle formations, or technical diagrams

What does NOT count as an illustration (IGNORE these completely):
- Library seals, stamps, or chops (圆形或方形的图书馆印章/藏书章)
- Personal name seals or red ink stamps (私人印章)
- Decorative borders, ornamental frames, or page dividers (装饰性边框/花边)
- Publisher logos or colophon decorations (出版社标志/装饰)
- Page numbers, running headers, or catalog marks
- Advertising pages or book promotion pages

How to count illustrations:
- One scene showing multiple people interacting (e.g. two fighters sparring) = ONE illustration, not two
- A single continuous drawing = ONE illustration, regardless of how many figures it contains
- Only count as separate illustrations if they are clearly separated by borders, whitespace, or text
